...
import { AUDIT_POINTS_DATA } from '../../types/AuditData'
...
function App() {
  ...
  const evidenceTargetId = useAppSelector((state) => state.audit.evidenceTargetId)
        ...
        <>
          ...
          {evidenceDialogOpen && (
            <EvidenceCollectionDialog
              ...
              auditPoints={AUDIT_POINTS_DATA[evidenceTargetId] || []}
            />
          )}
        </>
      )
